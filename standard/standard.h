...
#define MAVLINK_STANDARD_XML_HASH -4210550137249920964
...
#define MAVLINK_MESSAGE_CRCS {{0, 50, 9, 9, 0, 0, 0}, {33, 104, 28, 28, 0, 0, 0}, {300, 217, 22, 22, 0, 0, 0}}
#endif
...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_HEARTBEAT, MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT, MAVLINK_MESSAGE_INFO_PROTOCOL_VERSION}
# define MAVLINK_MESSAGE_NAMES {{ "GLOBAL_POSITION_INT", 33 }, { "HEARTBEAT", 0 }, { "PROTOCOL_VERSION", 300 }}
