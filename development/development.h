...
#define MAVLINK_DEVELOPMENT_XML_HASH 7660922636799901089
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_COMPONENT_CONTROL=248, /* Control the state or functionality of system components. |Component ID of the system component to be controlled.| Control command type being sent to the system component.| Component instance, when there is more than one instance per component.| Empty.| Empty.| Empty.| Empty.|  */
