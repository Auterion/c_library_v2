...
#define MAVLINK_MSG_ID_CELLULAR_MODEM_INFORMATION_LEN 109
#define MAVLINK_MSG_ID_CELLULAR_MODEM_INFORMATION_MIN_LEN 109
#define MAVLINK_MSG_ID_337_LEN 109
#define MAVLINK_MSG_ID_337_MIN_LEN 109

#define MAVLINK_MSG_ID_CELLULAR_MODEM_INFORMATION_CRC 191
#define MAVLINK_MSG_ID_337_CRC 191
...
#define MAVLINK_MESSAGE_INFO_CELLULAR_MODEM_INFORMATION { \
    ...
    7, \
    {  { "id", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_cellular_modem_information_t, id) }, \
         { "imei", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_cellular_modem_information_t, imei) }, \
         { "iccid", NULL, MAVLINK_TYPE_UINT64_T, 0, 8, offsetof(mavlink_cellular_modem_information_t, iccid) }, \
         { "imsi", NULL, MAVLINK_TYPE_UINT64_T, 0, 16, offsetof(mavlink_cellular_modem_information_t, imsi) }, \
         { "modem_id", NULL, MAVLINK_TYPE_CHAR, 10, 25, offsetof(mavlink_cellular_modem_information_t, modem_id) }, \
         { "firmware", NULL, MAVLINK_TYPE_CHAR, 24, 35, offsetof(mavlink_cellular_modem_information_t, firmware) }, \
         { "modem_model", NULL, MAVLINK_TYPE_CHAR, 50, 59, offsetof(mavlink_cellular_modem_information_t, modem_model) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CELLULAR_MODEM_INFORMATION { \
...
static inline uint16_t mavlink_msg_cellular_modem_information_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t id, uint64_t imei, uint64_t iccid, uint64_t imsi, const char *modem_id, const char *firmware, const char *modem_model)
{
    ...
    _mav_put_char_array(buf, 25, modem_id, 10);
    _mav_put_char_array(buf, 35, firmware, 24);
    _mav_put_char_array(buf, 59, modem_model, 50);
...
static inline void mavlink_msg_cellular_modem_information_send(mavlink_channel_t chan, uint8_t id, uint64_t imei, uint64_t iccid, uint64_t imsi, const char *modem_id, const char *firmware, const char *modem_model)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CELLULAR_MODEM_INFORMATION_LEN];
    _mav_put_uint64_t(buf, 0, imei);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_cellular_modem_information_send(chan, cellular_modem_information->id, cellular_modem_information->imei, cellular_modem_information->iccid, cellular_modem_information->imsi, cellular_modem_information->modem_id, cellular_modem_information->firmware, cellular_modem_information->modem_model);
#else
 ...
 */
static inline void mavlink_msg_cellular_modem_information_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t id, uint64_t imei, uint64_t iccid, uint64_t imsi, const char *modem_id, const char *firmware, const char *modem_model)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint64_t mavlink_msg_cellular_modem_information_get_iccid(const mavlink_message_t* msg)
{
...
{
    return _MAV_RETURN_char_array(msg, modem_id, 10,  25);
}
...
{
    return _MAV_RETURN_char_array(msg, firmware, 24,  35);
}
...
{
    return _MAV_RETURN_char_array(msg, modem_model, 50,  59);
}
...
static inline void mavlink_msg_cellular_modem_information_decode(const mavlink_message_t* msg, mavlink_cellular_modem_information_t* cellular_modem_information)
{
    ...
    cellular_modem_information->iccid = mavlink_msg_cellular_modem_information_get_iccid(msg);
