...
typedef enum UTM_DATA_AVAIL_FLAGS
{
   ...
   UTM_DATA_AVAIL_FLAGS_UAS_ID_AVAILABLE=2, /* The field uasId contains valid data. | */
   UTM_DATA_AVAIL_FLAGS_POSITION_AVAILABLE=4, /* The fields lat, lon, alt and relativeAlt contain valid data. | */
   UTM_DATA_AVAIL_FLAGS_ALTITUDE_AVAILABLE=8, /* The fields lat, lon, alt and relativeAlt contain valid data. | */
   UTM_DATA_AVAIL_FLAGS_NEXT_WAYPOINT_AVAILABLE=16, /* The fields next_at, next_lon and next_alt contain valid data. | */
   UTM_DATA_AVAIL_FLAGS_ENUM_END=17, /*  | */
