...
static void mavlink_test_alarm_report(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_alarm_report_t packet_in = {
        { 93372036854775807, 93372036854775808, 93372036854775809, 93372036854775810, 93372036854775811, 93372036854775812, 93372036854775813, 93372036854775814, 93372036854775815, 93372036854775816 },245,56
    };
    ...
    mavlink_msg_alarm_report_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_alarm_report_pack(system_id, component_id, &msg , packet1.alarm_mask , packet1.blocking_preflight , packet1.should_abort );
    mavlink_msg_alarm_report_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_alarm_report_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.alarm_mask , packet1.blocking_preflight , packet1.should_abort );
    mavlink_msg_alarm_report_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_alarm_report_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_alarm_report_send(MAVLINK_COMM_1 , packet1.alarm_mask , packet1.blocking_preflight , packet1.should_abort );
    mavlink_msg_alarm_report_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
