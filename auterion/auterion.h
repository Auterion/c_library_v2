...
#define MAVLINK_AUTERION_XML_HASH -6196469835917944365
...
#include "./mavlink_msg_onboard_computer_apps_status.h"
#include "./mavlink_msg_onboard_computer_app_failure.h"
