...
#define MAVLINK_AUTERION_XML_HASH -3472913692905157032
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_DO_CONTROL_TAKEOVER_OLD=670, /* Commands to take over control from the safety driver. This command cannot give control to safety driver. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_DO_ENGINE_LEG_TRIM_OLD=671, /* Set engine leg trim position. Can execute trim for individual legs or all legs at once. |Engine leg selection bitmask.| Executes engine leg trimming for all selected engines(0: Down, 1:up)| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_DO_SET_ENGINE_STATE_OLD=672, /* Commands the desired state for vehicle engines. |Engine selection bitmask.| Commanded engine state for the selected engines.| Empty| Empty| Empty| Empty| Empty|  */
...
#include "./mavlink_msg_boat_battery_status.h"
#include "./mavlink_msg_boat_fluid_level.h"
#include "./mavlink_msg_boat_speed.h"
#include "./mavlink_msg_boat_water_depth.h"
#include "./mavlink_msg_boat_wind_data.h"
