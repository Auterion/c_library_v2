...
#define MAVLINK_AUTERION_XML_HASH -8742458291036260461
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_ESAD=13673, /* Command for ESAD device. |Boolean indicating arm cmd (1).| Boolean indicating trigger cmd (1).| Empty| Empty| Empty| Empty| Empty|  */
...
#include "./mavlink_msg_esad_status.h"
