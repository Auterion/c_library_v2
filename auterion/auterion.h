...
#define MAVLINK_AUTERION_XML_HASH -5281488569300604830
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_PAYLOAD_DEVICE_TRIGGER=13800, /* Commands the payload device to trigger it's payload. |Set to 1 to trigger the payload device.| Empty| Empty| Empty| Empty| Empty| Empty|  */
