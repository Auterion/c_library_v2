...
static void mavlink_test_payload_device_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PAYLOAD_DEVICE_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_payload_device_status_t packet_in = {
        963497464,17,84,"GHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQ"
    };
    mavlink_payload_device_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.countdown = packet_in.countdown;
        packet1.state = packet_in.state;
        packet1.mode = packet_in.mode;
        
        mav_array_memcpy(packet1.message, packet_in.message, sizeof(char)*64);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PAYLOAD_DEVICE_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PAYLOAD_DEVICE_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_payload_device_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_payload_device_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_payload_device_status_pack(system_id, component_id, &msg , packet1.state , packet1.countdown , packet1.mode , packet1.message );
    mavlink_msg_payload_device_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_payload_device_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.state , packet1.countdown , packet1.mode , packet1.message );
    mavlink_msg_payload_device_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_payload_device_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_payload_device_status_send(MAVLINK_COMM_1 , packet1.state , packet1.countdown , packet1.mode , packet1.message );
    mavlink_msg_payload_device_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("PAYLOAD_DEVICE_STATUS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_PAYLOAD_DEVICE_STATUS) != NULL);
#endif
}

static void mavlink_test_aos_bundled_app_health_summary(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_AOS_BUNDLED_APP_HEALTH_SUMMARY >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_aos_bundled_app_health_summary_t packet_in = {
        5,72,139
    };
    mavlink_aos_bundled_app_health_summary_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.overall_health = packet_in.overall_health;
        packet1.failure_flags = packet_in.failure_flags;
        packet1.total_apps_count = packet_in.total_apps_count;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_AOS_BUNDLED_APP_HEALTH_SUMMARY_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_AOS_BUNDLED_APP_HEALTH_SUMMARY_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_aos_bundled_app_health_summary_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_aos_bundled_app_health_summary_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_aos_bundled_app_health_summary_pack(system_id, component_id, &msg , packet1.overall_health , packet1.failure_flags , packet1.total_apps_count );
    mavlink_msg_aos_bundled_app_health_summary_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_aos_bundled_app_health_summary_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.overall_health , packet1.failure_flags , packet1.total_apps_count );
    mavlink_msg_aos_bundled_app_health_summary_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_aos_bundled_app_health_summary_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_aos_bundled_app_health_summary_send(MAVLINK_COMM_1 , packet1.overall_health , packet1.failure_flags , packet1.total_apps_count );
    mavlink_msg_aos_bundled_app_health_summary_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("AOS_BUNDLED_APP_HEALTH_SUMMARY") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_AOS_BUNDLED_APP_HEALTH_SUMMARY) != NULL);
#endif
}

static void mavlink_test_aos_bundled_app_health(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_AOS_BUNDLED_APP_HEALTH >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_aos_bundled_app_health_t packet_in = {
        "ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVW",133,"ZABCDEFGHIJKLMNOPQRSTUVWXYZABCD","FGHIJKLMNOPQRSTUVWXYZABCDEFGHIJ"
    };
    mavlink_aos_bundled_app_health_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.failure_flags = packet_in.failure_flags;
        
        mav_array_memcpy(packet1.app_name, packet_in.app_name, sizeof(char)*128);
        mav_array_memcpy(packet1.expected_version, packet_in.expected_version, sizeof(char)*32);
        mav_array_memcpy(packet1.actual_version, packet_in.actual_version, sizeof(char)*32);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_AOS_BUNDLED_APP_HEALTH_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_AOS_BUNDLED_APP_HEALTH_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_aos_bundled_app_health_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_aos_bundled_app_health_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_aos_bundled_app_health_pack(system_id, component_id, &msg , packet1.app_name , packet1.failure_flags , packet1.expected_version , packet1.actual_version );
    mavlink_msg_aos_bundled_app_health_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_aos_bundled_app_health_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.app_name , packet1.failure_flags , packet1.expected_version , packet1.actual_version );
    mavlink_msg_aos_bundled_app_health_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_aos_bundled_app_health_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_aos_bundled_app_health_send(MAVLINK_COMM_1 , packet1.app_name , packet1.failure_flags , packet1.expected_version , packet1.actual_version );
    mavlink_msg_aos_bundled_app_health_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("AOS_BUNDLED_APP_HEALTH") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_AOS_BUNDLED_APP_HEALTH) != NULL);
#endif
}
...
static void mavlink_test_auterion(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_payload_device_status(system_id, component_id, last_msg);
    mavlink_test_aos_bundled_app_health_summary(system_id, component_id, last_msg);
    mavlink_test_aos_bundled_app_health(system_id, component_id, last_msg);
}
