...
#define MAVLINK_MSG_ID_ONBOARD_COMPUTER_APPS_STATUS_CRC 26
#define MAVLINK_MSG_ID_13801_CRC 26
...
#define MAVLINK_MESSAGE_INFO_ONBOARD_COMPUTER_APPS_STATUS { \
    ...
    {  { "overall_health", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_onboard_computer_apps_status_t, overall_health) }, \
         ...
         { "total_apps_count", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_onboard_computer_apps_status_t, total_apps_count) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ONBOARD_COMPUTER_APPS_STATUS { \
...
{
    return mavlink_msg_onboard_computer_apps_status_pack(system_id, component_id, msg, onboard_computer_apps_status->overall_health, onboard_computer_apps_status->failure_flags, onboard_computer_apps_status->total_apps_count);
}
...
{
    return mavlink_msg_onboard_computer_apps_status_pack_chan(system_id, component_id, chan, msg, onboard_computer_apps_status->overall_health, onboard_computer_apps_status->failure_flags, onboard_computer_apps_status->total_apps_count);
}
...
{
    return mavlink_msg_onboard_computer_apps_status_pack_status(system_id, component_id, _status, msg,  onboard_computer_apps_status->overall_health, onboard_computer_apps_status->failure_flags, onboard_computer_apps_status->total_apps_count);
}
...
MAVLINK_WIP
static inline void mavlink_msg_onboard_computer_apps_status_send(mavlink_channel_t chan, uint8_t overall_health, uint8_t failure_flags, uint8_t total_apps_count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ONBOARD_COMPUTER_APPS_STATUS_LEN];
    _mav_put_uint8_t(buf, 0, overall_health);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_onboard_computer_apps_status_send(chan, onboard_computer_apps_status->overall_health, onboard_computer_apps_status->failure_flags, onboard_computer_apps_status->total_apps_count);
#else
 ...
 */
MAVLINK_WIP
static inline void mavlink_msg_onboard_computer_apps_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t overall_health, uint8_t failure_flags, uint8_t total_apps_count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field total_apps_count from onboard_computer_apps_status message
 *
 * @return  
        Total number of default bundled apps tracked (number of
        ONBOARD_COMPUTER_APP_HEALTH messages to expect on request)
 ...
 */
MAVLINK_WIP
static inline uint8_t mavlink_msg_onboard_computer_apps_status_get_total_apps_count(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_onboard_computer_apps_status_decode(const mavlink_message_t* msg, mavlink_onboard_computer_apps_status_t* onboard_computer_apps_status)
{
    ...
    onboard_computer_apps_status->total_apps_count = mavlink_msg_onboard_computer_apps_status_get_total_apps_count(msg);
#else
