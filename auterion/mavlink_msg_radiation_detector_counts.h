...
#define MAVLINK_MSG_ID_RADIATION_DETECTOR_COUNTS 450
...
typedef struct __mavlink_radiation_detector_counts_t {
 ...
 uint64_t counts; /*< [n/a] Accumulated detector counts*/
...
#define MAVLINK_MSG_ID_450_LEN 32
#define MAVLINK_MSG_ID_450_MIN_LEN 32

#define MAVLINK_MSG_ID_RADIATION_DETECTOR_COUNTS_CRC 228
#define MAVLINK_MSG_ID_450_CRC 228
 ...
 * @param counts [n/a] Accumulated detector counts
 ...
 *
 * @return [n/a] Accumulated detector counts
 */
