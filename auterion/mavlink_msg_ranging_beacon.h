...
typedef struct __mavlink_ranging_beacon_t {
 ...
 float alt_ellipsoid; /*< [m] Beacon altitude (ellipsoid, WGS84). This field is preferred: alt_msl is a fallback.*/
 float alt_msl; /*< [m] Beacon altitude (MSL), fallback */
 ...
 uint32_t range_accuracy; /*< [mm] Estimated range measurement accuracy*/
...
#define MAVLINK_MSG_ID_RANGING_BEACON_LEN 48
#define MAVLINK_MSG_ID_RANGING_BEACON_MIN_LEN 48
#define MAVLINK_MSG_ID_513_LEN 48
#define MAVLINK_MSG_ID_513_MIN_LEN 48

#define MAVLINK_MSG_ID_RANGING_BEACON_CRC 133
#define MAVLINK_MSG_ID_513_CRC 133
...
#define MAVLINK_MESSAGE_INFO_RANGING_BEACON { \
    ...
    "RANGING_BEACON", \
    16, \
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 42, offsetof(mavlink_ranging_beacon_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 43, offsetof(mavlink_ranging_beacon_t, target_component) }, \
         { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_ranging_beacon_t, time_usec) }, \
         { "beacon_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 44, offsetof(mavlink_ranging_beacon_t, beacon_id) }, \
         ...
         { "alt_ellipsoid", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_ranging_beacon_t, alt_ellipsoid) }, \
         { "alt_msl", NULL, MAVLINK_TYPE_FLOAT, 0, 24, offsetof(mavlink_ranging_beacon_t, alt_msl) }, \
         ...
         { "rssi_node", NULL, MAVLINK_TYPE_INT8_T, 0, 45, offsetof(mavlink_ranging_beacon_t, rssi_node) }, \
         { "rssi_beacon", NULL, MAVLINK_TYPE_INT8_T, 0, 46, offsetof(mavlink_ranging_beacon_t, rssi_beacon) }, \
         { "sequence", NULL, MAVLINK_TYPE_UINT8_T, 0, 47, offsetof(mavlink_ranging_beacon_t, sequence) }, \
         { "carrier_freq", NULL, MAVLINK_TYPE_UINT16_T, 0, 40, offsetof(mavlink_ranging_beacon_t, carrier_freq) }, \
         { "range_accuracy", NULL, MAVLINK_TYPE_UINT32_T, 0, 36, offsetof(mavlink_ranging_beacon_t, range_accuracy) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_RANGING_BEACON { \
 ...
 * @param alt_ellipsoid [m] Beacon altitude (ellipsoid, WGS84). This field is preferred: alt_msl is a fallback.
 * @param alt_msl [m] Beacon altitude (MSL), fallback 
 ...
 * @param range_accuracy [mm] Estimated range measurement accuracy
...
static inline uint16_t mavlink_msg_ranging_beacon_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, uint64_t time_usec, uint8_t beacon_id, uint32_t range, int32_t lat, int32_t lon, float alt_ellipsoid, float alt_msl, uint32_t hacc_est, uint32_t vacc_est, int8_t rssi_node, int8_t rssi_beacon, uint8_t sequence, uint16_t carrier_freq, uint32_t range_accuracy)
{
    ...
    _mav_put_float(buf, 24, alt_msl);
    _mav_put_uint32_t(buf, 28, hacc_est);
    _mav_put_uint32_t(buf, 32, vacc_est);
    _mav_put_uint32_t(buf, 36, range_accuracy);
    _mav_put_uint16_t(buf, 40, carrier_freq);
    _mav_put_uint8_t(buf, 42, target_system);
    _mav_put_uint8_t(buf, 43, target_component);
    _mav_put_uint8_t(buf, 44, beacon_id);
    _mav_put_int8_t(buf, 45, rssi_node);
    _mav_put_int8_t(buf, 46, rssi_beacon);
    _mav_put_uint8_t(buf, 47, sequence);
...
{
    return mavlink_msg_ranging_beacon_pack(system_id, component_id, msg, ranging_beacon->target_system, ranging_beacon->target_component, ranging_beacon->time_usec, ranging_beacon->beacon_id, ranging_beacon->range, ranging_beacon->lat, ranging_beacon->lon, ranging_beacon->alt_ellipsoid, ranging_beacon->alt_msl, ranging_beacon->hacc_est, ranging_beacon->vacc_est, ranging_beacon->rssi_node, ranging_beacon->rssi_beacon, ranging_beacon->sequence, ranging_beacon->carrier_freq, ranging_beacon->range_accuracy);
}
...
{
    return mavlink_msg_ranging_beacon_pack_chan(system_id, component_id, chan, msg, ranging_beacon->target_system, ranging_beacon->target_component, ranging_beacon->time_usec, ranging_beacon->beacon_id, ranging_beacon->range, ranging_beacon->lat, ranging_beacon->lon, ranging_beacon->alt_ellipsoid, ranging_beacon->alt_msl, ranging_beacon->hacc_est, ranging_beacon->vacc_est, ranging_beacon->rssi_node, ranging_beacon->rssi_beacon, ranging_beacon->sequence, ranging_beacon->carrier_freq, ranging_beacon->range_accuracy);
}
...
{
    return mavlink_msg_ranging_beacon_pack_status(system_id, component_id, _status, msg,  ranging_beacon->target_system, ranging_beacon->target_component, ranging_beacon->time_usec, ranging_beacon->beacon_id, ranging_beacon->range, ranging_beacon->lat, ranging_beacon->lon, ranging_beacon->alt_ellipsoid, ranging_beacon->alt_msl, ranging_beacon->hacc_est, ranging_beacon->vacc_est, ranging_beacon->rssi_node, ranging_beacon->rssi_beacon, ranging_beacon->sequence, ranging_beacon->carrier_freq, ranging_beacon->range_accuracy);
}
...
static inline void mavlink_msg_ranging_beacon_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint64_t time_usec, uint8_t beacon_id, uint32_t range, int32_t lat, int32_t lon, float alt_ellipsoid, float alt_msl, uint32_t hacc_est, uint32_t vacc_est, int8_t rssi_node, int8_t rssi_beacon, uint8_t sequence, uint16_t carrier_freq, uint32_t range_accuracy)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_RANGING_BEACON_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_ranging_beacon_send(chan, ranging_beacon->target_system, ranging_beacon->target_component, ranging_beacon->time_usec, ranging_beacon->beacon_id, ranging_beacon->range, ranging_beacon->lat, ranging_beacon->lon, ranging_beacon->alt_ellipsoid, ranging_beacon->alt_msl, ranging_beacon->hacc_est, ranging_beacon->vacc_est, ranging_beacon->rssi_node, ranging_beacon->rssi_beacon, ranging_beacon->sequence, ranging_beacon->carrier_freq, ranging_beacon->range_accuracy);
#else
 ...
 */
static inline void mavlink_msg_ranging_beacon_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint64_t time_usec, uint8_t beacon_id, uint32_t range, int32_t lat, int32_t lon, float alt_ellipsoid, float alt_msl, uint32_t hacc_est, uint32_t vacc_est, int8_t rssi_node, int8_t rssi_beacon, uint8_t sequence, uint16_t carrier_freq, uint32_t range_accuracy)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return [m] Beacon altitude (ellipsoid, WGS84). This field is preferred: alt_msl is a fallback.
 */
 ...
 *
 * @return [m] Beacon altitude (MSL), fallback 
 */
 ...
 *
 * @return [mm] Estimated range measurement accuracy
 */
