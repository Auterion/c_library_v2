...
#define MAVLINK_MSG_ID_RADIATION_DETECTOR_SPECTRUM 451


typedef struct __mavlink_radiation_detector_spectrum_t {
 uint32_t serial_no; /*< [n/a] Detector serial number*/
 uint8_t msg_no; /*< [n/a] Message number [0;255]*/
 uint8_t seq_no; /*< [n/a] Sequence number [0;127]*/
 uint8_t segment[249]; /*< [n/a] One segment of a spectrum PDU*/
...
#define MAVLINK_MSG_ID_451_LEN 255
#define MAVLINK_MSG_ID_451_MIN_LEN 255

#define MAVLINK_MSG_ID_RADIATION_DETECTOR_SPECTRUM_CRC 235
#define MAVLINK_MSG_ID_451_CRC 235
 ...
 *
 * @param serial_no [n/a] Detector serial number
 * @param msg_no [n/a] Message number [0;255]
 * @param seq_no [n/a] Sequence number [0;127]
 * @param segment [n/a] One segment of a spectrum PDU
 ...
 *
 * @return [n/a] Detector serial number
 */
 ...
 *
 * @return [n/a] Message number [0;255]
 */
 ...
 *
 * @return [n/a] Sequence number [0;127]
 */
 ...
 *
 * @return [n/a] One segment of a spectrum PDU
 */
